...
import { IoIosRefresh, IoIosPizza, IoIosHeart, IoIosInfinite, IoLogoNodejs } from "react-icons/io";
...
const iconData = [
    ...
    Ionicons["IoIosChatbubbles"], Ionicons["IoIosCheckboxOutline"],
...
const IconData = [
    ...
    "IoIosCellular",
    "IoIosChatboxes",
    "IoIosChatbubbles", "IoIosCheckboxOutline",
    "IoIosCheckbox",
                        ...
                        <Card className="main-card mb-3">
                            <CardBody>
                                <Row>
                                    ...
                                    <Col md="2">
                                        <div className="font-icon-wrapper">
                                            <IoLogoNodejs icon="logo-nodejs" onClick={() => alert('Hi!')} fontSize="60px"
                                                color="#43853d" />
                                            <p>onClick event</p>
                                        </div>
                                    </Col>
